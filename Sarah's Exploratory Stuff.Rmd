...
meat %>% 
  ...
  labs(title = "Ranking Food Safety Importance between Household Sizes 
       in Hispanic and Non-Hispanic Populations", 
       x = "Household Size",
       y = "Food Safety Ranking on 1-5 Scale")
...
a <-meat %>%
  ggplot(aes(x = reason_religious_practice_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
...
b <- meat %>%
  ggplot(aes(x = reason_nonreligious_custom_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
...
c <- meat %>%
  ggplot(aes(x = reason_health_safety_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
...
d <- meat %>%
  ggplot(aes(x = reason_improve_taste_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
...
e <- meat %>%
  ggplot(aes(x = reason_improve_texture_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
...
f <- meat %>%
  ggplot(aes(x = reason_appearance_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
...
gg <- 
  summarise(meat, mean(reason_other_rank, na.rm = TRUE))
  
 # 2.390057 mean rank value for "other", found using 

g <- meat %>%
  ggplot(aes(x = reason_other_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
       title = "Other Reasons",
       x = "  ") +
...
work + plot_annotation(title = "Reasons for Washing Meat")
```
...
i <-meat %>%
  ggplot(aes(x = method_running_water_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
       title = "Running Water",
       x = "  ") +
...
j <- meat %>%
  ggplot(aes(x = method_water_rinse_bowl_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
       title = "Rinse in Bowl 
       with Water",
...
k <- meat %>%
  ggplot(aes(x = method_nonwater_rinse_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
...
l <- meat %>%
  ggplot(aes(x = method_water_soak_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
       title = "Soak in Water",
       x = "  ") +
...
m <- meat %>%
  ggplot(aes(x = method_nonwater_soak_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
...
n <- meat %>%
  ggplot(aes(x = method_other_rank, fill = "00FFFF")) +
  geom_histogram() +
  labs(y = "responses", 
       title = "Other",
       x = "  ") +
...
methods + plot_annotation(title = "Methods for Washing Meat")
...
o <- meat %>% 
  ...
  ggplot(aes(y = remove_pathogen_rank, fill = "00FFFF")) +
  geom_bar() +
  labs(x = "responses", 
       title = "Pathogens",
       y = "  ") +
...
p <-meat %>% 
  ...
  ggplot(aes(y = remove_chemicals_rank, fill = "00FFFF")) +
  geom_bar() +
  labs(x = "responses", 
       title = "Chemicals",
       y = "  ") +
...
q <- meat %>% 
  ...
  ggplot(aes(y = remove_inedible_rank, fill = "00FFFF")) +
  geom_bar() +
  labs(x = "responses", 
       title = "Inedible",
       y = "  ") +
...
r <- meat %>% 
  ...
  ggplot(aes(y = remove_undesirable_rank, fill = "00FFFF")) +
  geom_bar() +
  labs(x = "responses", 
       title = "Undesirable",
       y = "  ") +
...
s <- meat %>% 
  ...
  ggplot(aes(y = remove_blood_rank, fill = "00FFFF")) +
  geom_bar() +
  labs(x = "responses", 
       title = "Blood",
       y = "  ") +
...
t <- meat %>% 
  ...
  ggplot(aes(y = remove_slime_rank, fill = "00FFFF")) +
  geom_bar() +
  labs(x = "responses", 
       title = "Slime",
       y = "  ") +
...
u <- meat %>% 
  ...
  ggplot(aes(y = remove_fat_rank, fill = "00FFFF")) +
  geom_bar() +
  labs(x = "responses", 
       title = "Fat",
       y = "  ") +
...
v <- meat %>% 
  ...
  ggplot(aes(y = remove_liquid_rank, fill = "00FFFF")) +
  geom_bar() +
  labs(x = "responses", 
       title = "Liquids",
       y = "  ") +
...
w <- meat %>% 
  ...
  ggplot(aes(y = remove_other_rank, fill = "00FFFF")) +
  geom_bar() +
  labs(x = "responses", 
       title = "Other",
       y = "  ") +
...
concerns + plot_annotation(title = "What is Being Removed when Washing Meat?")
```
